...
###
 ...
 # @LastEditTime: 2023-12-20 15:30:06
 # @FilePath: /my-next-dashboard/shell/node.sh
 # @Description: 
...
status="active"
# 读取数据文件
while read -r language description project_name git_repo domain owner_id
do
    # 构建 SQL 插入语句
    SQL="INSERT INTO $DB_TABLE (language, description, project_name, git_repo, domain, status) VALUES ('$language', '$description', '$project_name', '$git_repo', '$domain', '$status');"
