...
import { UpdateTask, DeleteTask } from "@/app/ui/hosts/buttons";
import TaskStatus from "@/app/ui/hosts/status";

export default function Table({ items, page, mutate }) {
  return (
              ...
              >
                <div className="flex items-center justify-between border-b pb-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{item.ip}</p>
                  </div>
                ...
                >
                  <td className="whitespace-normal py-3 pl-6 pr-3">
                    <div className="flex items-center gap-3">
                      <p>
                        <Link href={`/dashboard/hosts/${item.id}/history`} prefetch>
                          {item.id}
                        </Link>
                      </p>
                    </div>
                  ...
                  <td className="whitespace-normal px-3 py-3">{item.area}</td>
                  <td className="whitespace-normal px-3 py-3">
                    {item.description}
                  </td>
                  <td className="whitespace-normal px-3 py-3">
