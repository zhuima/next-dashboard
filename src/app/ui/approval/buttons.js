 ...
 * @LastEditTime: 2023-12-18 14:48:00
 * @FilePath: /my-next-dashboard/src/app/ui/approval/buttons.js
 * @Description:
 *
...
export function CreateApproval() {
  return (
    <Link
      ...
      prefetch
    >
      <span className="hidden md:block">Create Approval</span>{" "}
      <AiOutlinePlus className="h-5 md:ml-4" />
    </Link>
  );
}

export function UpdateApproval({ id, page, className }) {
  return (
    <Link
      href={{
        pathname: `/dashboard/approval/${id}/edit`,
        query: { page: page },
      }}
...
export function DeleteApproval({ id, mutate, className }) {
